...
class TS_global_params:
    ...
    def __init__(self,xi=10,baseline_features=None,psi_features=None,responsivity_keys=None,uparams = None):
        ...
        self.mu_theta=[ 0.6936428 ,1.102400524 , 3.798137838 , 1.38479798,  0.00 , 0.0000000, 0.0 ,  0.142994513,0.0, 0.0000000, 0.0000000, -0.377272323, 0.0000000,0.0, 0.0000000, 0.0000000, -0.377272323,0.0000000]
            #[0.823,    1.949,    3.812,    -0.192,    0.763,    0,    -0.917,    0,
            # 0.47,    0,    0,    0,    0,
            #   0.47,    0,    0,    0,    0]
        self.sigma_theta =        np.diag([0.048940117, 0.056617391, 0.010013386, 0.058499409, 0.016413397, 0.041759494, 0.001067746,0.004113769, 0.016698171, 0.066573522,0.041759494, 0.019627005, 0.005363119, 0.016698171, 0.066573522,0.041759494, 0.019627005, 0.005363119])
