...
class TS_global_params:
    ...
    def __init__(self,xi=10,baseline_features=None,psi_features=None,responsivity_keys=None,uparams = None):
        try:
            with open('data/pooled_time_hyper/pooled_init_time_params.pkl','rb') as f:
                init_params = pickle.load(f)
        except:
            init_params = {'sigma_u':\
                    np.array([[ 0.46401414, -0.22239102],\
                          [-0.22239102,    0.10658676]]),\
                'noise_term':3.40815806388855,\
                'sigma_v':np.diag([0.07607637, 0.31001264])}
        ...
        self.mu_theta=[ 0.7195814 ,1.0501970 , 3.8017177 , 1.4010864,  0.00 , 0.0000000, 0.0 ,  0.1404336,0.0, 0.0000000, 0.0000000, -0.4492165, 0.0000000,0.0, 0.0000000, 0.0000000, -0.4492165,0.0000000]
            #[0.823,    1.949,    3.812,    -0.192,    0.763,    0,    -0.917,    0,
            # 0.47,    0,    0,    0,    0,
            #   0.47,    0,    0,    0,    0]
        self.sigma_theta =        np.diag([0.048476682, 0.056116233, 0.009993023, 0.058243804, 0.016237451, 0.040846192, 0.001059195,0.004110360, 0.016049044, 0.063623297, 0.040846192, 0.018740986, 0.005328073, 0.016049044,0.063623297, 0.040846192, 0.018740986, 0.005328073])
        ...
        self.sigma_v=init_params['sigma_v']
