...
from push_messages.clients import ApplePushClient, AppleDevelopmentPushClient, ClientBase, OnesignalMessageService, FirebaseMessageService
...
class PushMessageService():
    ...
    def get_client(self):
        client_types = {
            'onesignal': OnesignalMessageService,
