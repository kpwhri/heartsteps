...
ACTIVITY_SUGGESTION_TIME_OFFSET = env('ACTIVITY_SUGGESTION_TIME_OFFSET', default=10)
ACTIVITY_SUGGESTION_UPDATE_TIME = env('ACTIVITY_SUGGESTION_UPDATE_TIME', default='1:30')
