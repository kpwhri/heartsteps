...
ADHERENCE_MESSAGE_BUFFER_HOURS = env.int('ADHERENCE_MESSAGE_BUFFER_HOURS', 22)

PARTICIPANT_NIGHTLY_UPDATE_TIME = env.str('PARTICIPANT_NIGHTLY_UPDATE', default="1:30")
RANDOMIZATION_FIXED_PROBABILITY = env.float('RANDOMIZATION_FIXED_PROBABILITY', default=0.25)
HEARTSTEPS_LOCATIONS_NEAR_DISTANCE = env.float('HEARTSTEPS_LOCATIONS_NEAR_DISTANCE', default=0.25)

HEARTSTEPS_NIGHTLY_DATA_BUCKET = env.str('HEARTSTEPS_NIGHTLY_DATA_BUCKET', default='')
...
WALKING_SUGGESTION_DECISION_WINDOW_MINUTES = env.int('WALKING_SUGGESTION_DECISION_WINDOW_MINUTES', default=60)
...
FITBIT_ACTIVITY_DAY_MINIMUM_WEAR_DURATION_MINUTES = env.int('FITBIT_ACTIVITY_DAY_MINIMUM_WEAR_DURATION_MINUTES', default=480)
