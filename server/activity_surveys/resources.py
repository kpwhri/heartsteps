...
class ActivitySurveyDecisionResource(resources.ModelResource):
    ...
    fitbit_activity_id = Field(
        attribute = 'fitbit_activity__id',
    ...
    fitbit_activity_duration = Field(
        attribute = 'fitbit_activity__duration',
        column_name = 'Fitbit Activity Duration'
    )
    fitbit_activity_type = Field(
        attribute = 'fitbit_activity__type__name',
    ...
    def after_export(self, queryset, data, *args, **kwargs):
        ...
        for decision in queryset:
            if decision.activity_survey and hasattr(decision.activity_survey, '_questions'):
        ...
        for decision in queryset:
            if decision.activity_survey and hasattr(decision.activity_survey, '_answers'):
