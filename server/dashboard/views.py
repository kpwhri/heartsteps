...
# # TODO: maybe choose better view than CohortView
# class FeatureFlagAdherenceMessageView(CohortView):
#     # TODO: finish HTML template
#     template_name = 'dashboard/participant-feature-flags-adherence.html'
