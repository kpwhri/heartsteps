...
import { days, daysLong, months, monthsShort } from "./locales/en.js";
...
function tickHandler(evt) {
  ...
  switch(dateFormat) {
    case "heartStepsDate":
      dateString = `${dayNameLong} ${monthNameShort} ${dayNumberNoZero}`;
      break;
    case "shortDate":
