...
def export_all_data(export_dir, cohort="U01", exports=[],DEBUG=True):
    ...
    for u in users:
        ...
        try:
            ...
            if "daily.activitysuggestions" in exports or "daily" in exports  or "all" in exports:
                print("\n  Exporting daily activity suggestions")
                daily.export_daily_activity_suggestions(users[u], directory = user_export_directory, from_scratch=True,DEBUG=DEBUG)
