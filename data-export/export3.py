...
def export_all_data(export_dir, cohort="U01"):
    ...
    for u in users:
        try:
            ...
            export_daily_data(users[u], directory = user_export_directory, from_scratch=True)
...
def export_daily_data(user,directory = None, filename = None, start=None, end=None, from_scratch=True):
    ...
    #Get all weks where participant may have been active
...
export_all_data(EXPORT_DIRECTORY, cohort='U01')